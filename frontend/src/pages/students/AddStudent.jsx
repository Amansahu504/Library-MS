  ...
  return (
    <div className="min-h-screen bg-[#f4f6f7] p-6">
      <div className="bg-[#fdfefe] p-6 rounded-lg mb-6 shadow-lg border border-[#ecf0f1]">
        <h1 className="text-2xl font-bold text-[#2c3e50]">Add New Student</h1>
      </div>
      ...
      <div className="bg-[#fdfefe] shadow-lg rounded-lg p-6 border border-[#ecf0f1]">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-[#2c3e50] mb-2">Student No.</label>
            <input
              type="text"
              name="no"
              value={formData.no}
          ...
          <div>
            <label className="block text-[#2c3e50] mb-2">Roll Number</label>
            <input
              type="text"
              name="rollNo"
          ...
          <div>
            <label className="block text-[#2c3e50] mb-2">Department</label>
            <input
              type="text"
              name="department"
          ...
          <div>
            <label className="block text-[#2c3e50] mb-2">Batch</label>
            <input
              type="text"
              name="batch"
